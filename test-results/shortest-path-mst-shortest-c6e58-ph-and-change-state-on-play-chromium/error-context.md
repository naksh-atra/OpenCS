...
Locator:  locator('[data-testid="spmv-play"]')
Expected: "Pause"
Received: "Play"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="spmv-play"]')
    9 × locator resolved to <button data-testid="spmv-play" class="spmv-btn spmv-btn-primary">Play</button>
