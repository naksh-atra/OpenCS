...
- Name: topics.spec.ts >> topics page >> should render filter controls
- Location: tests\e2e\topics.spec.ts:9:3
...
Locator: locator('.filter-tabs')
Expected: visible
Error: strict mode violation: locator('.filter-tabs') resolved to 4 elements:
    1) <div class="filter-tabs" data-astro-cid-n7tr52od="">…</div> aka getByText('All Algorithms Data')
    2) <div class="filter-tabs" data-astro-cid-n7tr52od="">…</div> aka getByText('sequence treegraph')
    3) <div class="filter-tabs" data-astro-cid-n7tr52od="">…</div> aka getByText('beginner intermediate advanced')
    4) <div class="filter-tabs" data-astro-cid-n7tr52od="">…</div> aka getByText('published in-progress planned')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('.filter-tabs')
